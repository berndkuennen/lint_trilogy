	...
	Behave = Behave || function (userOpts) {
        ...
        action = {
            ...
            listen: function () {
                ...
                //-- added focus so that textarea does automatically resize after load while autofocus
                utils.addEvent(defaults.textarea, 'focus',   function(){ utils._callHook('focus'); });
